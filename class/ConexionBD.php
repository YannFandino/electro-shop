...
class ConexionBD {
    ...
    private $user = 'id4923139_root';
    private $pass = 'electro_tienda';
    private $bbdd = 'id4923139_electro_tienda';
    ...
    // Funcion para cerrar la conexi�n a la base de datos
